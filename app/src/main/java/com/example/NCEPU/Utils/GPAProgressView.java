...
public class GPAProgressView extends View {
    /**
     * 背景的圆
     */
    ...
    public GPAProgressView(Context context) {
        this(context, null);
    }

    public GPAProgressView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GPAProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
