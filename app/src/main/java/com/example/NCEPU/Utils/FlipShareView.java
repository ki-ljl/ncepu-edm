...
public class FlipShareView extends View {
    ...
    //shareItem lists
    public List<ShareItem> mItemList = new ArrayList<>();
    ...
    private void initView() {
        ...
        float width = sharedPreferences.getInt("width", 0);
        float time = width / 360;  //倍数
        mPath = new Path();
        mPaint = new Paint();
        mPaint.setAntiAlias(true);
        mPaint.setStyle(Paint.Style.FILL);
        mPaint.setTextSize(sp2px(14 * time));
        mCamera = new Camera();
        mMatrix = new Matrix();
    ...
    public static class Builder {
        ...
        public Builder(Activity activity, View parentView, int width) {
            mActivity = activity;
            mParentView = parentView;
            mWidth = width;
        }
