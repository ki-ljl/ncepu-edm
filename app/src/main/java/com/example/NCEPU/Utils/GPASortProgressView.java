...
public class GPASortProgressView extends View {
    /**
     * 背景的圆
     */
    ...
    public GPASortProgressView(Context context) {
        this(context, null);
    }

    public GPASortProgressView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GPASortProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float currentAngle = (float) (currentRank * sweepAngle / totalRank);
        canvas.drawArc(rectF, startAngle, currentAngle, false, mPaintCurrent);

        String text1 = currentRank + "/" + totalRank;
        String text2 = "GPARank";
         ...
         * 完成
         */
        if (getOnLoadingCompleteListenter() != null && currentRank == totalRank) {
